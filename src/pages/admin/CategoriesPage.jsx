...
const STYLE = `
  ...
  .cat-card-grid::-webkit-scrollbar { height: 8px; }
  .cat-card-grid::-webkit-scrollbar-thumb { background: rgba(28,26,23,.18); border-radius: 999px; }
  .cat-card-grid::-webkit-scrollbar-track { background: transparent; }
  .cat-card {
    flex: 0 0 220px;
